...
export default function Fredo() {
    return (
        <main>
            <Header/>
            <Banner background={'#171B1F'} title ={"Fredo"} subtitle ={"Branding • UI/UX"} image={"/images/fredo/fredo.png"}/>
            <section className='my-120'>
                    <div className="container">
                        <div className="team">
                            <div className="work1 work3">
                                <h2>About</h2>
                                <p>Fredo is a new-age, research-based, no non-sense kinda platform that brings intelligent and informed business, finance and economy related conversations to chai-addas and dinner tables.</p>
                            </div>
                ...
                <section className='my-120'>
                    <div className="container">
                        <div className="team">
                            <div className="work1 work3">
                                <h2>Improved User Experience of the Mobile App</h2>
                                <p>They showed us a high fidelity wireframe created by one of their team member
                                    & asked us to improve the visual language & the whole user experience of it.
                                    So we started taking inspiration from multiple inspirational websites & similar real apps such as Finshots, inshorts & so on.
                                    <br/>
                                    <br/>
                                    To improve the whole User experience we created a design language for Fredo in which we improved Icons, ui components, typography, colors etc. The first few drafts of the dummy screens didn’t work well for them, so we showed some more drafts & they finalised the best one.</p>
                            </div>
                ...
                <section className='my-120'>
                    <div className="container">
                        <div className="team">
                            <div className="work1 work3">
                                <h2>Main Menu Screens</h2>
                                <p>Main menu consists of 5 different major screens like speed news, readOn, gamification, explore & membership (coming soon for full version)</p>
                            </div>
                ...
                <section className='my-120'>
                    <div className="container">
                        <div className="team">
                            <div className="work1 work3">
                                <h2>Community & Other Screens</h2>
                                <p>While working on other screens, We tried out various concepts for the community section (only for the full version). Because it is one of the primary monetizing options for the product, the client wanted it to have a perfect flow and visuals.
                                    To give it a premium look we used dark theme & 3d icons here as well & the result was pretty good.</p>
                            </div>
       ...
       image="/images/index/testimonial/shantanu.png" name="Shantanu Jain" designation="Founder, Fredo" />
