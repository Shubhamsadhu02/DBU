...
export default function Boxfile() {
  return (
    <main>
      ...
      <Header/>
      <Banner background={'#07A6D4'} title="Boxfile" subtitle="Branding • Advertising • UI/UX" image="/images/boxfile/Boxfile.png" />
      ...
      <section className='section-margin'>
        <div className="container">
          <div className="team">
            ...
            <div>
              <Image height={600 } width={1096} layout="responsive" src="/images/boxfile/About.png" />
            </div>
          </div>
        </div></section>
      <section className='section-margin'>
        <div className="container">
          <div className="team">
            ...
            <div>
              <Image height={705} width={1096} layout="responsive" src="/images/boxfile/Challenge.png" />
            </div>
          </div>
        </div></section>
      <section className='section-margin'>
        <div className="container">
          <div className="team">
            ...
            <br />
            <div>
              <Image height={866} width={1096} layout="responsive" src="/images/boxfile/Brand5.png" />
            </div>
          </div>
        </div></section>
      <section className='section-margin'>
        <div className="container">
          <div className="team">
            ...
            <div>
              <Image height={718} width={1096} layout="responsive" src="/images/boxfile/Website1.png" />
            </div>
            <br />
            <div>
              <Image height={974} width={1096} layout="responsive" src="/images/boxfile/Website2.png" />
            </div>
            <br />
